...
class Topology(Topo):
    def build(self):
        # Create routers with loopback addresses
        ...
        # Create hosts
        self.addHost('h211', ip='10.2.1.1/24', defaultRoute='via 10.2.1.254')
        self.addHost('h311', ip='10.3.1.1/24', defaultRoute='via 10.3.1.254')
        self.addHost('h411', ip='10.4.1.1/25', defaultRoute='via 10.4.1.126')  # IP of r410-eth0
        self.addHost('h412', ip='10.4.1.129/25', defaultRoute='via 10.4.1.254')  # IP of r410-eth1

        # Link hosts to routers
        self.addLink("h211", "r210", intfName2='r210-eth0', params2={'ip': '10.2.1.254/24'})
        self.addLink("h311", "r310", intfName2='r310-eth0', params2={'ip': '10.3.1.254/24'})
        self.addLink("h411", "r410", intfName2='r410-eth0', params2={'ip': '10.4.1.126/25'})
        self.addLink("h412", "r410", intfName2='r410-eth1', params2={'ip': '10.4.1.254/25'})

        # Link routers to each other
        self.addLink("r210", "r110",
                     intfName1='r210-eth1', params1={'ip': '172.17.1.1/31'},
